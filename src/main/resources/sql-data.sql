...
INSERT INTO `ims`.`orders` (`customer_id`, `order_date`, `total_cost`) VALUES ('1', '2020-11-18', '699.99');
...
INSERT INTO `ims`.`items` (`item_title`, `quantity`, `price`) VALUES ('Fender Telecaster - Black', '100', '699.99');
INSERT INTO `ims`.`orders` (`customer_id`, `order_date`, `total_cost`) VALUES ('2', '2020-11-17', '699.99');
...
INSERT INTO `ims`.`items` (`item_title`, `quantity`, `price`) VALUES ('PRS - Red', '100', '799.99');
INSERT INTO `ims`.`orders` (`customer_id`, `order_date`, `total_cost`) VALUES ('3', '2020-11-16', '799.99');
